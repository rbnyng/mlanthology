...
def get_api_key(env_var: str, api_key: Optional[str] = None) -> Optional[str]:
    """Return an API key from the explicit argument or an environment variable."""
    return api_key or os.environ.get(env_var, "").strip() or None
